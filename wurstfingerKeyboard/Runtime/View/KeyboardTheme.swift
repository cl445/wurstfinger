...
/// colors and do not carry a theme. The Dark Gold style renders from a
/// user-configurable palette instead (`SettingsKey.theme*`), so it looks the
/// same in light and dark mode by design.
struct KeyboardTheme: Equatable {
    ...
    /// The default Dark Gold palette: dark slate keys, golden main letters,
    /// white hints, thin key edges. Fixed by design — identical in light and
    /// dark mode.
    static let darkGold = KeyboardTheme(preset: .standard)
...
/// One of the built-in palettes: a key fill, a main-letter color, a hint
/// color, and a lightened key fill shown while the key is pressed. Each
/// preset carries a short descriptive name for the theme settings page.
struct KeyboardThemePreset: Equatable, Identifiable {
    ...
    /// The built-in palettes offered on the theme settings page.
    static let all: [KeyboardThemePreset] = [
        .init(id: 0, name: "Black & Yellow", keyHex: "#000000", mainHex: "#FFF828", hintHex: "#FFFFFF", pressedHex: "#1E1E1E"),
        .init(id: 1, name: "Black & Red", keyHex: "#000000", mainHex: "#FA3838", hintHex: "#FFA459", pressedHex: "#1E1E1E"),
        .init(id: 2, name: "Terracotta", keyHex: "#8A5042", mainHex: "#000000", hintHex: "#1F2A4F", pressedHex: "#C87460"),
        .init(id: 3, name: "Black & Violet", keyHex: "#000000", mainHex: "#CC66FF", hintHex: "#FF578A", pressedHex: "#1E1E1E"),
        .init(id: 4, name: "Jade", keyHex: "#009C7D", mainHex: "#FF0000", hintHex: "#FFEE00", pressedHex: "#1EE2B5"),
        .init(id: 5, name: "Cornflower", keyHex: "#5599EE", mainHex: "#6611AA", hintHex: "#6611DD", pressedHex: "#7BDDFF"),
        .init(id: 6, name: "Turquoise", keyHex: "#00C8CC", mainHex: "#4D2D78", hintHex: "#FFFF00", pressedHex: "#1EFFFF"),
        .init(id: 7, name: "Mustard", keyHex: "#E1CF04", mainHex: "#265100", hintHex: "#186EAA", pressedHex: "#FFFF22"),
        .init(id: 8, name: "Grape", keyHex: "#8822CC", mainHex: "#68FF32", hintHex: "#55DCDC", pressedHex: "#C540FF"),
        .init(id: 9, name: "Scarlet", keyHex: "#EE3A3A", mainHex: "#FFD900", hintHex: "#6E0000", pressedHex: "#FF5858"),
        .init(id: 10, name: "Olive", keyHex: "#4A4400", mainHex: "#75C012", hintHex: "#EBEB33", pressedHex: "#6B621E"),
        .init(id: 11, name: "Rust", keyHex: "#8A2E00", mainHex: "#FF5A51", hintHex: "#FFEE00", pressedHex: "#C84C1E"),
        .init(id: 12, name: "Slate & Gold", keyHex: "#333A48", mainHex: "#D1AA05", hintHex: "#FFFFFF", pressedHex: "#4A5468"),
        .init(id: 13, name: "Forest", keyHex: "#265C00", mainHex: "#FFB947", hintHex: "#16FF00", pressedHex: "#44851E"),
        .init(id: 14, name: "Midnight Blue", keyHex: "#1D2F80", mainHex: "#06CDF5", hintHex: "#FFEE00", pressedHex: "#3B4DB9"),
        .init(id: 15, name: "Espresso", keyHex: "#261001", mainHex: "#F1F506", hintHex: "#FF1E00", pressedHex: "#442E1F"),
    ]

    /// Slate & Gold, the palette behind the Dark Gold style and the fallback
    /// for unparsable stored colors.
