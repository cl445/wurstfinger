...
struct MultiLanguageSettingsTests {
    ...
    private func makeSettings(defaults: UserDefaults, selectedId: String = "en_US", enabledIds: [String]? = nil) -> LanguageSettings {
    ...
    func migrationSeedsFromSelected() {
        ...
        let settings = makeSettings(defaults: defaults, selectedId: "de_DE")
    ...
    func loadsEnabledList() {
        ...
        let settings = makeSettings(defaults: defaults, selectedId: "en_US", enabledIds: ["en_US", "ru_RU", "de_DE"])
    ...
    func toggleEnablesLanguage() {
        ...
        let settings = makeSettings(defaults: defaults, selectedId: "en_US", enabledIds: ["en_US"])
    ...
    func disablingSelectedSwitchesToFirst() {
        ...
        let settings = makeSettings(defaults: defaults, selectedId: "ru_RU", enabledIds: ["en_US", "ru_RU", "de_DE"])
        settings.toggleLanguage(.russian)
    ...
    func nextLanguageCyclesTwoLanguages() {
        ...
        let settings = makeSettings(defaults: defaults, selectedId: "en_US", enabledIds: ["en_US", "ru_RU"])
    ...
    func nextLanguageCyclesManyLanguages() {
        ...
        let settings = makeSettings(defaults: defaults, selectedId: "en_US", enabledIds: ids)
    ...
    func hasMultipleLanguagesFlag() {
        ...
        let single = makeSettings(defaults: defaults, selectedId: "en_US", enabledIds: ["en_US"])
        #expect(single.hasMultipleLanguages == false)

        let multi = makeSettings(defaults: defaults, selectedId: "en_US", enabledIds: ["en_US", "ru_RU"])
    ...
    func languageLabelUppercase() {
        ...
        let enSettings = makeSettings(defaults: defaults, selectedId: "en_US", enabledIds: ["en_US"])
        #expect(enSettings.currentLanguageLabel == "EN")

        let ruSettings = makeSettings(defaults: defaults, selectedId: "ru_RU", enabledIds: ["ru_RU"])
        #expect(ruSettings.currentLanguageLabel == "RU")

        let deSettings = makeSettings(defaults: defaults, selectedId: "de_DE", enabledIds: ["de_DE"])
    ...
    func staleIdsFiltered() {
        ...
        let settings = makeSettings(defaults: defaults, selectedId: "en_US", enabledIds: ["en_US", "zz_ZZ", "ru_RU"])
    ...
    func selectedNotEnabledReselectsFirstEnabled() {
        ...
        let settings = makeSettings(defaults: defaults, selectedId: "ru_RU", enabledIds: ["en_US"])
        #expect(settings.selectedLanguageId == "en_US")
        #expect(settings.enabledLanguageIds == ["en_US"])
...
struct PinnedLanguageTests {
    ...
    func pinSetsId() {
        ...
        let settings = makeSettings(defaults: defaults, enabledIds: ["en_US", "ru_RU"])
    ...
    func unpinSameLanguage() {
        ...
        let settings = makeSettings(defaults: defaults, enabledIds: ["en_US", "ru_RU"], pinnedId: "ru_RU")
        settings.pinLanguage(.russian)
    ...
    func pinDifferentLanguage() {
        ...
        let settings = makeSettings(defaults: defaults, enabledIds: ["en_US", "ru_RU"], pinnedId: "en_US")
        settings.pinLanguage(.russian)
        #expect(settings.pinnedLanguageId == "ru_RU")
    }
    ...
    func pinDisabledLanguageEnablesIt() {
        ...
        let settings = makeSettings(defaults: defaults, enabledIds: ["en_US"])
        settings.pinLanguage(.russian)
        #expect(settings.pinnedLanguageId == "ru_RU")
        #expect(settings.enabledLanguageIds.contains("ru_RU"))
    }
    ...
    func disablingPinnedLanguageClearsPin() {
        ...
        let settings = makeSettings(defaults: defaults, selectedId: "en_US", enabledIds: ["en_US", "ru_RU"], pinnedId: "ru_RU")
        settings.toggleLanguage(.russian)
        #expect(settings.pinnedLanguageId == nil)
    }
    ...
    func stalePinnedIdCleared() {
        ...
        let settings = makeSettings(defaults: defaults, enabledIds: ["en_US", "ru_RU"], pinnedId: "zz_ZZ")
        #expect(settings.pinnedLanguageId == nil)
    }
    ...
    func pinnedNotInEnabledCleared() {
        ...
        let settings = makeSettings(defaults: defaults, enabledIds: ["en_US"], pinnedId: "ru_RU")
        #expect(settings.pinnedLanguageId == nil)
    }
